...
class Config(object):
    ...
    testcase_path = conf_parser.get('Testcase', 'testcase_path')
    ...
    debug_root_path      = os.path.join(ROOT_DIR, conf_parser.get("Debug", "debug_root_path"))
    return_json_path     = os.path.join(debug_root_path, conf_parser.get("Debug", "return_json_path"))
    dependency_pic_path  = os.path.join(debug_root_path, conf_parser.get("Debug", "dependency_pic_path"))
